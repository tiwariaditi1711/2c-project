...
var disableddates = ["25-5-2017", "26-5-2017", "27-5-2017", "28-5-2017"];
...
socket.on('BookingDetails', function(data){
  ...
  if(!data.Status){
    ...
    console.log(data);
    var customer = $cookies.getObject('authUser');
    document.getElementById('drivername').innerHTML = data.DriverDetails.fname +" "+data.DriverDetails.lname;
    ...
    $scope.Booking.Fare = $scope.fr;//totalAmount;
    $scope.Booking.Customer = customer.currentUser.userInfo;
    $scope.Booking.Distance = $scope.dst;//distance;
